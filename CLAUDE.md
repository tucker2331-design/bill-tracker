...
| Bug fixed | `docs/failures/assumptions_audit.md` — numbered, append-only; then re-run `python3 tools/reindex_caselaw.py` to refresh the top `## Index` (B-2; same for `gemini_review_patterns.md`) |
