...
### 6. Noise Words Negative Filter
- **What it assumes:** We know ALL noise patterns in advance
- **How it breaks:** New administrative action types would pass through as events
- **Fix in progress:** Positive identification with UNKNOWN flagging
