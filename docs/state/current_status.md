...
| # | Branch | State | Notes |
|---|--------|-------|-------|
| _none_ | — | — | PR #31 merged; PR #32 (docs sync) is the only candidate currently in flight — see Recently closed once it lands. |
...
## Next PR (PR#31 merged 2026-04-26 — see Recently closed)
