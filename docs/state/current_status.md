...
4. **B-2, B-4, B-5, B-6** — brain hygiene ([[audits/fable_2026-07/brain_audit]]); **S-3/S-4/S-5/S-6** sweep tail ([[audits/fable_2026-07/sweep_findings]]).
...
- **2026-07-04 — Fable audit delivered** ([[audits/fable_2026-07/README]] = the queue) + VA to-do cleared (#190–#195: Health flood, Timeline floor stages, chief-patron full name, deploy prep).
- **≤2026-07-03 — accuracy + product history** → [[state/status_archive_2026H1]] (Section 9 = 0, C8.4, incremental STM, session archive, the forward-build backend + front end).
