...
- [[testing/subject_labels]] — **LIS subjects, TWO spaces: coarse (43 subjects, 76% of corpus, 95.8% cold) for broad cuts + fine (458 real LIS subjects, 55%, 97.6%) for topic cuts; **union 80%**. The fine space exists because the rollup was DELETING Firearms/Marijuana/Zoning/Police. Read every accuracy against its null baseline.**
