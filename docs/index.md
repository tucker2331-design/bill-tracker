...
- [[testing/subject_labels]] — **LIS subjects, TWO spaces: coarse (43 subjects, 67% of corpus, 97.8% cold) for broad cuts + fine (458 real LIS subjects, 50%, 99.8%) for topic cuts; union 72%. The fine space exists because the rollup was DELETING Firearms/Marijuana/Zoning/Police — 56% of subject mentions. Read every accuracy against its null baseline.**
