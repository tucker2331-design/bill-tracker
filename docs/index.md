...
- [[testing/committee_seat]] — **THE LEVER: put the bill in a room your patron SITS IN. 70% vs 56% raw (+14), +8 within patron x subject (p=3.4e-07), and +18 in the natural experiment where the same patron's seat on the same room changed between sessions (p=9.3e-04). Difficulty control only +1.8pt. Worth most to MINORITY patrons (+13). Companion NULL: a prolific patron is not spread thin — volume vs pass rate r=+0.02.**
