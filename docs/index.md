...
- [[testing/subject_labels]] — **LIS subjects extended from the 2 sessions that publish them to all 18: 14,839 bills (65%) at 96.9% cold-session accuracy. Unlocks the minority penalty BY TOPIC across 18 sessions (25 topics, 46pt for Public Service Companies down to 14pt for ABC). Known gap: marijuana 33%.**
